...
<?php
        ...
        if(isset($_POST['save']))
        {
        if(!empty($_POST['NAMEU'])){ if(!empty($_POST['price'])){ 
        $name_usl = strip_tags(trim($_POST['NAMEU']));
        $price_usl = strip_tags(trim($_POST['price']));
        ...
        <form method="post" action="edit_post_usl.php?id=<?php echo $id; ?>">
          <div class="fff">
